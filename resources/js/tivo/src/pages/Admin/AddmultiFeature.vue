                ...
                <div class="card-body">
                    <div class="product-info">
                        <div class="inputField">
                            <input type="text " class="form-control" placeholder="Enter Add New Feature" v-model="addNewItem">
                            <button type="submit" class="btn" @click="addNewFeature()"> Add New Feature</button>
                        </div>
