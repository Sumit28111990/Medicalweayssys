    ...
    methods: {
        handlePageChange(page) {
            ...
            if (this.filterQuery) {
                axios
                    .get(
                        `${config.apiUrl}/api/quote-form?page=${this.pagination.current_page}&search=${this.filterQuery}`,
                        {
                            headers: {
                ...
                axios
                    .get(
                        `${config.apiUrl}/api/quote-form?page=${this.pagination.current_page}`,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                            },
        ...
        convert(data) {
            this.$router.replace(`/create-Administration-form/${data}-0`);
        ...
        addEmployee() {
            this.$router.replace("/create-quote-form");
        },
        EditForm(data) {
        ...
        DeleteForm(data) {
            ...
            if (confirm("Do you really want to delete?")) {
                axios
                    .delete(`${config.apiUrl}/api/quote-form/${data}`, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    })
        ...
        ViewForm(data) {
            this.$router.push(`/quote-view-form/${data}`);
        },
        ...
        getFormFieldsList() {
            let token = localStorage.getItem("token");
            // console.log(token);
            let promise = axios.get(config.apiUrl + "/api/quote-form", {
                headers: {
        ...
        filter() {
            ...
            if (this.filterQuery.length > 0) {
                axios
                    .get(
                        `${config.apiUrl}/api/quote-form?search=${this.filterQuery}`,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                            },
                ...
                axios
                    .get(`${config.apiUrl}/api/quote-form`, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    })
