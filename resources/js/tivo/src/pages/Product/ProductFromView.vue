    ...
    <div class="row">
        <div
            ...
            :class="
                ...
                data.field_type == 'dropdownSelect' ||
                data.field_type == 'time' ||
                data.field_type == 'date' ||
                data.field_type == 'number'
                    ? 'col-md-12 labelMargindown'
        ...
        <!-- {{ data }} -->
            ...
            <div v-if="data.field_type == 'text'">
                <div>
                    <div class="d-flex">
                        ...
                        <div>
                            <span class="text-danger h5">
                                {{
                                    data.validation_rules.is_required ? "*" : ""
                                }}
                            </span>
                        </div>
                    </div>
                    ...
                    />
                    <span class="text-danger" v-for="(err, index) in error">
                        <span
                            class="text-danger"
            ...
            <div v-if="data.field_type == 'dropdownSelect'">
                <div v-if="data.label_name == 'Category'">
                    ...
                    >
                        ...
                        <option v-for="item in parentIdValue" :value="item.id">
            ...
            <div v-if="data.field_type == 'time'">
                <div>
                    ...
                    >
                        ...
                        <option v-for="time in timeList" :value="time">
                            {{ time }}
                        </option>
                    </select>
                    <span class="text-danger" v-for="(err, index) in error">
            ...
            <div v-if="data.field_type == 'checkbox'">
            ...
            <div v-if="data.field_type == 'radio'">
                <div class="d-flex">
                    <div class="d-flex">
                        <div>
                            <label :for="data.input_name">{{
                    ...
                    <div
                        v-for="(item, index) in data.field_values"
                        :key="index"
                        class="d-flex mx-2"
                    >
                        <div>
...
/* @media   only screen and (min-width: 768px) { .textAeraSize {
        width: 650px !important;
    }
}
@media  only screen and  (min-width: 1024px) { .textAeraSize {
